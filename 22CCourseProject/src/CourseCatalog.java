...
public class CourseCatalog {
	...
	private final String[] mainMenuItems = { "1. Add new course", "2. Delete course", "3. Search course",
			"4. Display courses", "5. Write data to a file", "Q. Quit" };

	private final String[] searchMenuItems = { "1. Find course by CRN code", "2. Find by title", "B. Back" };
	private final String[] listMenuItems = { "1. Display unsorted data", "2. Display data sorted by the CRN code",
			"3. Display data sorted by the Title", "B. Back" };
	...
	/**
	 * Delete menu asks user about crn code for removig and delete this course if it
	 * exist or inform not found if not
	 * 
	 * @param sc
	 */
	...
	/**
	 * Search menu makes search courses by crn or title, shows result of search or
	 * inform that not found
	 * 
	 * @param sc
	 */
