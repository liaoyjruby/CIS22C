...
public class Course implements Comparable<Course>{
    ...
    */
	...
	/**
     * Default empty constructor for the Course class in order to compare
     */
	private Course() {
	}
	
	/**
     * Creates a new Course object with only courseID variable set
     * @param courseID the course ID to be set on the new Course object
     * @return Course object with set courseID variable
     */
	...
	/**
     * Creates a new Course object with only title variable set
     * @param title the course title to be set on the new Course object
     * @return Course object with set title variable
     */
	...
	/**
     * Creates a new Course object with only courseID and title variables set
     * @param courseID the course ID to be set on the new Course object
     * @param title the course title to be set on the new Course object
     * @return Course object with set courseID and title variable
     */
